...
import { BASEHUB_BLOCK_DOCS } from "../utils/constants";
  ...
  try {
    ...
    return {
      content: [
        {
          type: "text",
          text: `Before giving you the structure, here's some important info about the BaseHub data model. Use this as a reference.

BaseHub's API is graphql-based, and supports query and mutation ops. The query schema is dynamically generated from the repository structure.
        ...
        },
        {
          ...
          text:
            ("_structure" in result
              ? result._structure || "The repository structure is empty"
